    ...
    return (
        <div className="header">
            ...
            <div className="header__search">
                <input type="text" className="header__searchUserName" value={userName}  onChange={(e)=>setUserName(e.target.value)}/>
                 <input type="text" className="header__searchRepoName" value={repoName}  onChange={(e)=>setRepoName(e.target.value)}/>
            </div>
